                        ...
                        success: function (data) {
                            ...
                            if (categoryListDto.ResultStatus === 0) {
                                ...
                                $.each(categoryListDto.Categories.$values, function (index, category) {
                                    tableBody += `
                            <tr name="${category.Id}"> <!-- name attribute EKLENDİ -->
                                <td>${category.Id}</td>
                                <td>${category.Name}</td>
                ...
                $.post(actionUrl, dataToSend).done(function (data) {
                    ...
                    if (isValid) {
                        ...
                        $('#validation-summary > ul > li').each(function () {
                            errorList += `<li>${$(this).text()}</li>`;  // HTML listesi oluştur
                        });

                        // Toastr'da HTML formatında göster
                        toastr.warning(`
                                ...
                                `, "", { allowHtml: true });  // allowHtml: true ile HTML render et
                    }
                });
            });
    });
