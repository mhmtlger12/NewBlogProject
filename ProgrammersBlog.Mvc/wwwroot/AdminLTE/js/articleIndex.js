$(document).ready(function () {
                            ...
                            if (articleResult.Data.ResultStatus === 0) {
                                ...
                                $.each(articleResult.Data.Articles.$values,
                                    function (index, article) {
                                        ...
                                        let newMenu = getJsonNetObject(newArticle.Menu, newArticle);
                                        if (newMenu !== null) {
                                            menusArray.push(newMenu);
                                        }
                                        if (newMenu === null) {
                                            newMenu = menusArray.find((menu) => {
                                                return menu.$id === newArticle.Menu.$ref;
                                            });
                                        }
    ...
    $(document).on('click', '.btn-update', function () {
        ...
        window.open(`${url}/Update?articleId=${id}`, "_self");
    });
