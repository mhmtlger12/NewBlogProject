...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public UserController(UserManager<User> userManager, IMapper mapper, SignInManager<User> signInManager = null, IImageHelper imageHelper = null, IToastNotification toastNotification = null):base(userManager, mapper, imageHelper)
        {
        ...
        public async Task<IActionResult> Delete(Guid userId)
        {
            ...
            else
            {
                ...
                var deletedUserErrorModel = JsonSerializer.Serialize(
                    new UserDto
                    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isVerified)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        _toastNotification.AddSuccessToastMessage($"Şifreniz başarıyla değiştirilmşir.");
                        return View();
                    }
                    else
                    {
        ...
        [Authorize(Roles = "SuperAdmin,User.Read")]
        [HttpGet]
        public async Task<PartialViewResult> GetDetail(Guid userId)
        {
